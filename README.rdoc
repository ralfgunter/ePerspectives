...
* add_server/3 - [IP, Port, Public_Key]: adds a notary server to the servers list; currently, Public_Key is required but ignored (signature verification is not done yet);
