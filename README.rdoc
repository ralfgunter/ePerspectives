...
After the installation, you can start the server/scanner from the <b>server/ebin</b> folder as follows:
...
If you want more information, it is recommended that you start the eshell with the flag <b>-boot start_sasl</b>, though that might slow down things. Finally, the shell command <b>appmon:start()<\b> gives you a nice visual overview how things are running (click on persp_server to see more).
